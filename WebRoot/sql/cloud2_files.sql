...
update cloud2_files set f_pos=posSvr,f_lenSvr=lenSvr,f_perSvr=perSvr,f_complete=complete 
...
update cloud2_files set f_lenSvr=fd_lenSvr,f_perSvr=perSvr where f_uid=uidSvr and f_id=fd_idSvr;