...
function FileDownloaderMgr()
{
    ...
    this.Config = {
		...
		, "Company"         : "荆门泽优软件有限公司"
		, "License"         : ""//
        , "UrlCreate"       : "http://localhost:8080/Uploader6.2MySQL/downloader/db/f_create.jsp"
        , "UrlDel"          : "http://localhost:8080/Uploader6.2MySQL/downloader/db/f_del.jsp"
        , "UrlList"         : "http://localhost:8080/Uploader6.2MySQL/downloader/db/d_list.jsp"
        , "UrlListCmp"      : "http://localhost:8080/Uploader6.2MySQL/downloader/db/f_list_cmp.jsp"
        , "UrlUpdate"       : "http://localhost:8080/Uploader6.2MySQL/downloader/db/f_update.jsp"
        , "UrlDownload"     : "http://localhost:8080/Uploader6.2MySQL/downloader/db/f_down.jsp"
        //文件夹
        , "UrlFdCreate"     : "http://localhost:8080/Uploader6.2MySQL/downloader/db/fd_create.jsp"
        , "UrlFdJson"       : "http://localhost:8080/Uploader6.2MySQL/downloader/db/fd_json.jsp"
        , "UrlFdDel"        : "http://localhost:8080/Uploader6.2MySQL/downloader/db/fd_del.jsp"
        , "UrlFdUpdate"     : "http://localhost:8080/Uploader6.2MySQL/downloader/db/fd_update.jsp"
        //x86
...
function FolderDowner(idLoc,fdID,name,mgr)
{
    ...
    this.SvrCreate = function ()
    {
        $.ajax({
            ...
            , data: { uid: _this.Fields["uid"],name:encodeURIComponent(_this.name),fdid:_this.fdID,mac:_this.mac,pathLoc:encodeURIComponent(_this.cfgPath), time: new Date().getTime() }
            , success: function (v)
            {
...
function FileDowner(fileID, fileUrl, mgr)
{
    ...
    this.SvrCreate = function ()
    {
        ...
        $.ajax({
            ...
            {
                var obj = JSON.parse(decodeURIComponent(json.value));
                //var json = eval(msg);
                //json = json[0];
                _this.inited = true;
                _this.idSvr = obj.idSvr;
                //文件已经下载完
    ...
    this.SvrDelete = function ()
    {
        $.ajax({
            ...
            , data: { uid: _this.Fields["uid"], fid: this.idSvr, mac: _this.mac, time: new Date().getTime() }
            , success: function (json)
            {
                //var res = eval(msg);
            }
