...
String cloud	= request.getParameter("cloud");//云配置信息
CloudConfig cc	= new CloudConfig();
if(!StringUtils.isBlank(cloud)) cc = (CloudConfig)JSONObject.toBean(JSONObject.fromObject(cloud),CloudConfig.class);
...
//所有单个文件均以md5方式存储
PathCloudBuilder pb = new PathCloudBuilder();
pb.m_url = cc.fileUrl;
